        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-12">
          ...
          <ScrollReveal delay={0.4}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <Button
                size="lg"
                className="w-full sm:w-auto text-lg px-10 py-6 bg-brand-accent hover:bg-white hover:text-brand-black transition-all duration-300 transform hover:-translate-y-1 shadow-lg shadow-brand-accent/20"
                onClick={() => window.open("https://nyalicrossfit.wodify.com/OnlineSalesPage/Main?q=Classes%7cOnlineMembershipId%3d249561%26LocationId%3d10746%26ProgramId%3d114395%26IsToViewScheduleOnly%3dTrue", "_blank", "noopener,noreferrer")}
              >
                Book a Free Trial
              </Button>
              <Link to="/schedule">
