...
const WEEKLY_TEMPLATE: { [key: number]: any[] } = {
  ...
  1: [
    ...
    { id: 'mon-4', title: 'Introduction Class', start_time: '08:10', duration_minutes: 30, coach: 'Gym Instructor', location: 'Intro Area', intensity: 'Low' },
    { id: 'mon-5', title: 'Female Only CrossFit', start_time: '08:45', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'Medium' },
    ...
    { id: 'mon-7', title: 'Female Only CrossFit', start_time: '11:15', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'Medium' },
    ...
    { id: 'mon-10', title: 'Introduction Class', start_time: '17:00', duration_minutes: 30, coach: 'Gym Instructor', location: 'Intro Area', intensity: 'Low' },
    ...
    { id: 'mon-12', title: 'CrossFit', start_time: '18:15', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'High' },
    { id: 'mon-13', title: 'Introduction Class', start_time: '18:15', duration_minutes: 30, coach: 'Gym Instructor', location: 'Intro Area', intensity: 'Low' },
  ...
  2: [
    ...
    { id: 'tue-4', title: 'Introduction Class', start_time: '08:10', duration_minutes: 30, coach: 'Gym Instructor', location: 'Intro Area', intensity: 'Low' },
    { id: 'tue-5', title: 'Female Only CrossFit', start_time: '08:45', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'Medium' },
    ...
    { id: 'tue-7', title: 'Female Only CrossFit', start_time: '11:15', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'Medium' },
    { id: 'tue-8', title: 'CrossFit', start_time: '14:45', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'High' },
    { id: 'tue-9', title: 'Introduction Class', start_time: '15:00', duration_minutes: 30, coach: 'Gym Instructor', location: 'Intro Area', intensity: 'Low' },
    ...
    { id: 'tue-11', title: 'Introduction Class', start_time: '17:00', duration_minutes: 30, coach: 'Gym Instructor', location: 'Intro Area', intensity: 'Low' },
    ...
    { id: 'tue-13', title: 'Introduction Class', start_time: '18:15', duration_minutes: 30, coach: 'Gym Instructor', location: 'Intro Area', intensity: 'Low' },
    { id: 'tue-14', title: 'Upper Body Mobility', start_time: '18:15', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'Medium' },
    { id: 'tue-15', title: 'Spinning Session', start_time: '19:00', duration_minutes: 45, coach: 'Gym Instructor', location: 'Spin Studio', intensity: 'High' },
    { id: 'tue-16', title: 'CrossFit', start_time: '19:15', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'High' },
  ...
  3: [
    ...
    { id: 'wed-4', title: 'Female Only CrossFit', start_time: '08:45', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'Medium' },
    ...
    { id: 'wed-6', title: 'Female Only Mobility', start_time: '11:15', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'Medium' },
    ...
    { id: 'wed-9', title: 'Introduction Class', start_time: '17:00', duration_minutes: 30, coach: 'Gym Instructor', location: 'Intro Area', intensity: 'Low' },
    ...
    { id: 'wed-11', title: 'CrossFit', start_time: '18:15', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'High' },
    { id: 'wed-12', title: 'Introduction Class', start_time: '18:15', duration_minutes: 30, coach: 'Gym Instructor', location: 'Intro Area', intensity: 'Low' },
  ...
  4: [
    ...
    { id: 'thu-4', title: 'Introduction Class', start_time: '08:10', duration_minutes: 30, coach: 'Gym Instructor', location: 'Intro Area', intensity: 'Low' },
    { id: 'thu-5', title: 'Female Only CrossFit', start_time: '08:45', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'Medium' },
    ...
    { id: 'thu-7', title: 'Female Only CrossFit', start_time: '11:15', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'Medium' },
    { id: 'thu-8', title: 'Massage', start_time: '12:00', duration_minutes: 60, coach: 'Gym Instructor', location: 'Recovery Area', intensity: 'Low' },
    { id: 'thu-9', title: 'CrossFit', start_time: '14:45', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'High' },
    { id: 'thu-10', title: 'Introduction Class', start_time: '15:00', duration_minutes: 30, coach: 'Gym Instructor', location: 'Intro Area', intensity: 'Low' },
    { id: 'thu-11', title: 'CrossFit', start_time: '16:00', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'High' },
    { id: 'thu-12', title: 'Introduction Class', start_time: '17:00', duration_minutes: 30, coach: 'Gym Instructor', location: 'Intro Area', intensity: 'Low' },
    { id: 'thu-13', title: 'CrossFit', start_time: '17:15', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'High' },
    { id: 'thu-14', title: 'Introduction Class', start_time: '18:15', duration_minutes: 30, coach: 'Gym Instructor', location: 'Intro Area', intensity: 'Low' },
    { id: 'thu-15', title: 'Lower Body Mobility', start_time: '18:15', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'Medium' },
    { id: 'thu-16', title: 'Spinning Session', start_time: '19:00', duration_minutes: 45, coach: 'Gym Instructor', location: 'Spin Studio', intensity: 'High' },
    { id: 'thu-17', title: 'CrossFit', start_time: '19:15', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'High' },
    { id: 'thu-18', title: 'CrossFit', start_time: '20:30', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'High' },
  ],
  // Friday
  5: [
    ...
    { id: 'fri-4', title: 'Introduction Class', start_time: '08:10', duration_minutes: 30, coach: 'Gym Instructor', location: 'Intro Area', intensity: 'Low' },
    { id: 'fri-5', title: 'Female Only CrossFit', start_time: '08:45', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'Medium' },
    ...
    { id: 'fri-7', title: 'Female Only CrossFit', start_time: '11:15', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'Medium' },
    { id: 'fri-8', title: 'Massage', start_time: '12:00', duration_minutes: 60, coach: 'Gym Instructor', location: 'Recovery Area', intensity: 'Low' },
    { id: 'fri-9', title: 'CrossFit', start_time: '14:45', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'High' },
    ...
    { id: 'fri-11', title: 'Introduction Class', start_time: '17:00', duration_minutes: 30, coach: 'Gym Instructor', location: 'Intro Area', intensity: 'Low' },
    { id: 'fri-12', title: 'CrossFit Open', start_time: '17:15', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'High' },
  ...
  6: [
    ...
    { id: 'sat-5', title: 'Female Only Lower Body Mobility', start_time: '11:15', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'Medium' },
    ...
    { id: 'sat-7', title: 'CrossFit', start_time: '14:45', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'High' },
    { id: 'sat-8', title: 'CrossFit', start_time: '16:00', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'High' },
    { id: 'sat-9', title: 'CrossFit', start_time: '17:15', duration_minutes: 60, coach: 'Gym Instructor', location: 'Crossfit Floor', intensity: 'High' },
  ],
  // Sunday
  0: [
                          ...
                          {groups[time].map((session) => (
                            ...
                            >
                              <div className="flex justify-between items-start mb-3 border-b border-gray-100 pb-3">
                                <div>
                                  <div className="font-bold text-2xl leading-none text-gray-900">{formatTime(session.start_time)}</div>
                                  <div className="text-[11px] font-semibold text-gray-400 mt-1.5">{formatDuration(session.duration_minutes)}</div>
                                </div>
                                <div className={`w-3 h-3 rounded-full ${getClassColor(session.title)} ring-4 ring-gray-50 flex-shrink-0 mt-0.5`} />
                              </div>

                              <h3 className="font-medium text-gray-900 text-lg leading-snug mb-4 line-clamp-2">
                                {session.title}
                              </h3>

                              <div className="space-y-2 mt-auto bg-gray-50 -mx-2 px-3 py-2.5 rounded-lg border border-gray-100/50">
